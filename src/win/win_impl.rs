...
use windows::Win32::UI::{
    Input::KeyboardAndMouse::{
        ...
        MOUSEEVENTF_XUP, MOUSEINPUT, MOUSE_EVENT_FLAGS, VIRTUAL_KEY, HKL,
    },
...
mod test {
    ...
    fn extended_key() {
        ...
        for key in known_extended_keys {
            assert_eq!(true, super::Enigo::is_extended_key(key))
        }
    }
    ...
    fn regular_key() {
        ...
        for key in known_ordinary_keys {
            assert_eq!(false, super::Enigo::is_extended_key(key))
        }
    }
}
